...
const handleSubmit = async (e) => {
  ...
  if (!formData.username || !formData.email || !formData.password){
    return setErrorMessage('Please fill out all fields :3')
  }
  try {
    setLoading(true);
      ...
      <div className='flex-1'>
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
          ...
          <div className=''>
            ...
            <TextInput type='password' placeholder='Password1234' id='password' onChange={handleChange}/>
          </div>
          <Button gradientDuoTone='redToYellow' type='submit' pill disabled={loading}>
          {
            loading ? (
              <>
              <Spinner size="sm"/>
